#!/usr/bin/env bash
#
# This file is copied from: https://github.com/microsoft/vscode-dev-containers/blob/v0.169.0/containers/docker-from-docker/.devcontainer/library-scripts/docker-debian.sh
